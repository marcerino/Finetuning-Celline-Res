...
do
    ...
    flexynesis \
        ...
        --finetuning_samples /data/local/mgiller/atlas_tissue_representation/Data/more_than_25_samples/subsampling/Samplelist_${SAMPLES}_samples_${i}_version.txt \
        --prefix ${SAMPLES}_FinetuneSamples_resample_run_${i}
