...
#SBATCH --output=/data/local/mgiller/atlas_tissue_representation/top10features/flexynesis_%A_%a.out  # %A is job ID, %a is array index
#SBATCH --gpus=1
...
flexynesis \
    ...
    --outdir /data/local/mgiller/atlas_tissue_representation/top10features \
