...
SAMPLE_SIZES=(0 50 75 100 125 150 175 200)
...
flexynesis \
    ...
    --outdir /data/local/mgiller/atlas_tissue_representation/size_filterd/geq_25_samples \
    --target_variable uberon_tissue \
    --finetuning_samples $SAMPLES \
    --prefix ${SAMPLES}_FinetuneSamples
