#!/bin/bash
#SBATCH --job-name=fullgex_flexynesis_sweep
#SBATCH --output=./fullgex-finetune/finetunerun-out/flexynesis_%A_%a.out  # %A is job ID, %a is array index
#SBATCH --gpus=1
