...
- Running the from_scratch.sh script to create the  
- The plots are created via the 


# Observation
Performance of Model on its original Dataset. 
```
...
Based upon the confusion Metrics, this plot shows the change of \[Label, Label\] over the process of Finetuning.

# Interpretation
Although dependent on the mapping from Oncodisease to uberon tissue, the Model shows a notable increase of Accuracy through finetuning and outperforms models trained upon the same data.
